...
# モデルのロード
model = keras.models.load_model('saved_model/my_model5000@block7.103.5')
...
print(f"モデルAI（黒）の勝利数: {model_wins}")
print(f"ランダムAI（白）の勝利数: {random_wins}")
print(f"引き分け: {draws}")

# # 結果の表示
# print(f"{num_simulations}回の対戦結果:")
# print(f"ランダムAI（黒）の勝利数: {model_wins}")
# print(f"モデルAI（白）の勝利数: {random_wins}")
# print(f"引き分け: {draws}")