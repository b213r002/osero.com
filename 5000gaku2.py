...
model.add(layers.Dropout(0.4))  # 過学習を抑制するドロップアウト
...
model.fit(x_train, y_train_reshape, epochs=40, batch_size=32, validation_split=0.2, callbacks=[tb_cb])
model.save('saved_model2/my_model5000@2')
