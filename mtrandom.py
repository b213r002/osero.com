...
# モデルのロード
model = keras.models.load_model('saved_model_reversi/my_model1000')
...
def play_game(model):
    ...
    while True:
        ...
        if is_black_turn:
            ...
            move = random_move(board, is_black_turn)
...
def simulate_games(num_games):
    ...
    print(f"モデルAIの勝利数: {model_wins}")
    print(f"Random AIの勝利数: {random_wins}")
    print(f"引き分け数: {draws}")

# 対戦をシミュレーション
simulate_games(20)  # 100試合をシミュレーション
...
# # 結果表示
# print(f"最終スコア: モデルAI(黒) = {black}, ランダムAI(白) = {white}")
# if black > white:
#     print("モデルAIの勝利!")
# elif white > black:
#     print("ランダムAIの勝利!")
